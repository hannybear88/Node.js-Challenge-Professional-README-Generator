...
function generateMarkdown(data) {
  ...
  const sectionArr = [
      ...
      {
          header: 'Acceptance Criteria And Screensho Links',
          content: acceptanceCriteriaAndScreenshotLinks(data.acceptanceCriteriaAndScreenshotLinks)
      },
      // {
      //     header: 'Screenshots',
      ...
      {
          header: 'Technologies',
          content: createBuiltWith(data['technologies'])
      },
      {
          header: 'License',
