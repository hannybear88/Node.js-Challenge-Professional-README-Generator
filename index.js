...
const acceptanceCriteriaAndScreenshots = [
    {
        type: 'input',
        name: 'acceptanceCriteriaAndScreenshotLinks',
        message: 'Please provide the acceptance criteria and links for your screenshot. (Required)',
        validate: acceptanceCriteriaAndScreenshotLinksInput => {
            if (acceptanceCriteriaAndScreenshotLinksInput) {
                return true;
            } else {
                console.log('Please provide the acceptance criteria and links for your screenshot!')
                return false;
            }
        }
    },
